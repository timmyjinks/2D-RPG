...
public class UserChoice {
    ...
    public String start(){
        return prompt("You're leaving a bustling town, eager to explore the forest beyond. " +
    ...
    public String Forest(){
        return (prompt("While walking inside the lush forest",
    ...
    public String Forest1(){
        return (prompt("When getting closer",
    ...
    public String Forest2(){
        return prompt("When looking at the marks on the tree",
    ...
    public String Forest3(){
        return prompt("Feeling intune with nature.",
    ...
    public String Mountain(){
        return prompt("While scaling the rigged path",
    ...
    public String Mountain1(){
        return (prompt("While trying to scale the cliff",
    ...
    public String Mountain2(){
        return (prompt("Moving up the mountain",
    ...
    public String Mountain3(){
        return (prompt("While studying the rock form",
    ...
    public String Town(){
        return (prompt("You arrive to the town then",
    ...
    public String Town1(){
        return (prompt("While entering the town you decide",
    ...
    public String Town2(){
        return (prompt("When you looking around the outskirt",
    ...
    public String Town3(){
        return (prompt("The town is thriving with life.",
    ...
    public String Barbarian(){
        return classSout("Barbarian", "A fierce warrior of primitive background who can enter a battle rage");
    }
    public String Bard(){
        return classSout("Bard","An inspiring magician whose power echoes the music of creation");
    }
    public String Cleric(){
        return classSout("Cleric","A priestly champion who wields divine magic in service of a higher power");
    }
    public String Druid(){
        return classSout("Druid","A priest of the Old Faith, wielding the powers of nature — moonlight and plant growth, fire and lightning — and adopting animal forms");
    }
    public String Wizard(){
        return classSout("Wizard","A scholarly magic-user capable of manipulating the structures of reality");
    }
    public String Monk(){
        return classSout("Monk","A master of martial arts, harnessing the power of the body in pursuit of physical and spiritual perfection");
    }
    public String Paladin(){
        return classSout("Paladin","A holy warrior bound to a sacred oath");
    }
    public String Warlock(){
        return classSout("Warlock","A wielder of magic that is derived from a bargain with an extraplanar entity");
    }
    public String Rogue(){
        return classSout("Rouge","A scoundrel who uses stealth and trickery to overcome obstacles and enemies");
    }
    public String classSout(String className, String prompt){
        return "Based on your path... Class " + className + " : \n" + prompt;
    }
}