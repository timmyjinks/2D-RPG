...
public class ItemSprite {
    ...
    public static void refresh() {
        ...
        CHARACTER_ITEM_SLOT = new Sprite(new Texture("Character_Screen_Item_Slot.png"), 208, 208);;
        MENU_BODY = new Sprite(new Texture("Character_Screen_Background.png"), 1120, 1360);;
