...
import com.neumont.model.entity.Barbarian;
import com.neumont.model.entity.Paladin;
import com.neumont.model.entity.Player;
import com.neumont.model.entity.Wizard;
import com.neumont.view.MyIO;
import com.neumont.view.Node;
...
public class BinaryTreeController {
    ...
    public void endOfPath() {
        if (root == forestEnd || root == mountainEnd || root == townEnd) {
            ...
            if (root == forestEnd) {
                root = forestEnd = new Node("you are a mage", new Wizard(characterName));
